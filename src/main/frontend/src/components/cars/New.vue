      ...
      <form @submit.prevent="submitForm">
        <div class="flex -mx-4 mb-8">
          <div class="w-1/3 mx-4">
            ...
            <p class="w-3/4 leading-normal">Basic information about this vehicle. Further details can be updated after registration.</p>
          </div>
          <div class="w-2/3 mx-4">
            <div class="mb-4">
              ...
              <input type="text" v-model="vehicle.brand" class="w-full bg-grey-lighter rounded p-4" placeholder="e.g. Mercedes, BMW, Volkswagen..."/>
            </div>
            <div class="mb-4">
              <label class="mb-2 inline-block">
                Model
              </label>
              <input type="text" v-model="vehicle.model" class="w-full bg-grey-lighter rounded p-4" placeholder="e.g. i3, Model S, 308..."/>
            </div>
            <div class="mb-4">
              <label class="mb-2 inline-block">
                Body Type
